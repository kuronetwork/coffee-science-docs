...
「冷藏 4°C 最容易打發」是因為冷牛奶有更長的時間窗口讓蛋白質從冷態被擾動到展開、再形成穩定膜。如果用常溫牛奶起手，蛋白質還沒被充分擾動就已經到達高溫區，泡沫粗糙不穩。
...
| 微奶泡（microfoam）| 像濕油漆、光滑反光 | 拉花、所有奶咖 |
...
:::warning[蛋白變性的時機]
SCA Barista 課程裡常說「打奶不要超過 65°C」，但蛋白變性其實 60°C 就開始發生。65°C 是甜感流失的拐點，70°C 是「明顯不對」的上限。要做出最甜的奶咖，目標溫度落在 55-62°C 區間。
:::
